...
def videoAnalysisMultipleVideosWithinOne(curTest, numberTests, tupleForProcessing, data_from_tests, direcPythonFile, filename_output_video, fps_out, limToCompare):
       ...
       # if curTest == 0:
        ...
        elif curTest == numberTests -1 or curTest == numberTests:  
                    ...
                    for x in range(0, numberTests):
                        for y in range(0, numberTests):
                           ...
                           #         proc_algorithm(x, y)
                                    ...
                                    fixed_roi_path_one = data_test_one[-2]
                                    fixed_roi_path_two = data_test_one[-2]
