...
def sepVideosFromWholeOne(inputVideoFlag, inputVideo):
    ...
    def get_partial_videos(lims, video_total_time, durTotal, buffer_imgs):
        ...
        for ind_l, l in enumerate(lims):
            ...
            while not_created:
                ...
                start_number_img = int((start_time/video_total_time)*durTotal)
                end_number_img = int((end_time/video_total_time)*durTotal) 
       ...
       ##         output_video_name = input("Enter a name for the output video: ")
        ...
        return output_video_filenames, fps, n_imgs
    ...
    #    else:
        ...
        output_video_filenames, fps, n_images = get_partial_videos(lims, video_total_time, durTotal, buffer_imgs)
    ...
    return output_video_filenames, fps, n_images
