...
##   print("Press any leter from the keyboard to continue ...")
 ...
 ##          cv2.namedWindow('image', cv2.WINDOW_NORMAL)
        ...
        ##       time.sleep(1000)
         ...
         ##           cv2.imwrite(base_path + "/image" + str(ind_img) + ".tiff", img)
               ...
               out = cv2.VideoWriter('test_' + '00' + str(curTest) + '.avi',cv2.VideoWriter_fourcc(*'DIVX'), 15, size)
               ...
               shutil.copy2('test_' + '00' + str(curTest) + '.avi', folderThisTest)
               
               time.sleep(10)
               
               print("Video " + 'test_' + '00' + str(curTest) + '.avi')
               
               if os.path.isfile('test_' + '00' + str(curTest) + '.avi'):
               ...
               sequence_name = curTest
               print("Cur Test: " + str(curTest))
               print("Seq Name: " + str(sequence_name))
 ...
 #              pathRoiStart = pathRoiStart + dateTimeMarker 
  #             pathRoiEnd = pathRoiEnd + dateTimeMarker 
            ...
            #       gap_between_tests *= 60
                   print("Gap here: " + str(gap_between_tests))
               ...
               if curTest != numberTests-1:
                   ...
                   diff_time_extra = (abs(t_another-tx))/60
                   
                   print("Inter gap: " + str(gap_bet_tests-diff_time_extra))
